...
import com.cakestore.cakestore.repository.OtpTokenRepository;
...
public class OtpService {
    ...
    public boolean verifyOtp(String email, String code, OtpToken.Purpose purpose) {
        ...
        Optional<OtpToken> tokenOpt = otpRepo.findTopByUserAndPurposeOrderByCreatedAtDesc(user, purpose);
