// CakeStore/src/main/java/com/cakestore/cakestore/controller/InventoryController.java
...
public class InventoryController {
    ...
    public InventoryController(InventoryService inventoryService, BranchService branchService, ProductService productService) {
    ...
    public String showEditForm(@PathVariable Long id, Model model, RedirectAttributes ra) {
        ...
        if (inventory == null) {
            ra.addFlashAttribute("error", "Tồn kho không tồn tại.");
    ...
    // POST /admin/inventory/update - Xử lý cập nhật tồn kho (Dùng cho cả tạo mới/cập nhật)
    @PostMapping("/update")
    public String updateInventory(@RequestParam Long branchId,
        ...
        try {
            ...
            return "redirect:/admin/inventory/new"; // Quay về form nhập nếu tạo mới lỗi
        }
        return "redirect:/admin/inventory";
    }

    // GET /admin/inventory/new - Form tạo mới (chủ yếu là nhập kho)
    @GetMapping("/new")
    public String showCreateForm(Model model) {
        ...
        model.addAttribute("branches", branchService.findAllActive());
        // Lấy danh sách sản phẩm (có thể cần phải phân trang/search nếu quá nhiều)
        model.addAttribute("products", productService.findPaginatedProducts(null, null, PageRequest.of(0, 1000)).getContent()); 
        return "admin/inventory-form";
    }
}